...
from config import ACCEPT, TARGET, MARKUP_ANALYZER, PROGRESS_BAR_SETTING  # noqa
...
def get_category(user_agent: list, proxies: list):
    ...
    for item in tqdm(items, desc='Retrieving product categories', bar_format=PROGRESS_BAR_SETTING):
